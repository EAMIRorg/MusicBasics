...
This allows us to distribute Music Basics under its open-source license and to maintain the project without legal ambiguity.

We can offer both open-source and commercial licenses.
Music Basics is available under the AGPLv3, and we may also offer commercial licenses to developers who need to build proprietary applications. The CLA makes this possible while keeping the open-source version available to everyone.

WHAT THE CLA DOES NOT DO

It does not affect music, audio, or other creative works you create using Music Basics.
Anything you compose, record, or produce with the software is entirely yours.

It does not restrict your ability to fork, modify, or use Music Basics under its open-source license.
...
The CLA helps us keep Music Basics open, usable, and sustainable for the long term — for researchers, musicians, developers, and commercial users alike.
